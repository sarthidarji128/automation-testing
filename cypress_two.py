...
TEST_SPEC = "cypress/e2e/create_group_all_users.cy.js"
...
def wait_for_server(url: str, timeout_seconds: int = 15) -> None:
    ...
    raise SystemExit(
        f"The local server is not reachable at {url}. Start main.py first or let this script launch it. Last error: {last_error}"
    )
